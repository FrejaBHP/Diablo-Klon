...
public static class UILib {
	...
	public static readonly Color ColorStatusNeutral = new(0.1f, 0.1f, 0.1f, 0.6f);
	public static readonly Color ColorStatusPositive = new(0.1f, 0.35f, 0.1f, 0.6f);
	public static readonly Color ColorStatusNegative = new(0.35f, 0.1f, 0.1f, 0.6f);
	...
	public static readonly Texture2D AEffectSoulrend = GD.Load<Texture2D>("res://textures/ui/aeffect_Soulrend.png");
}
